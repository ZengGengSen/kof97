...
u8  bios_sys_stopper = 0;           /// 0x10fe8c
u8  _bios_unknown08[50] = {};       /// 50 bytes
...
u8  _bios_unknown13[3] = {};        /// 3 bytes
u8  bios_cp_p1status = 0;           /// 0x10fee8
u8  bios_cp_p1previous = 0;         /// 0x10fee9
u8  bios_cp_p1current = 0;          /// 0x10feea
u8  bios_cp_p1change = 0;           /// 0x10feeb
u8  bios_cp_p1repeat = 0;           /// 0x10feec
u8  bios_cp_p1timer = 0;            /// 0x10feed
u8  bios_cp_p2status = 0;           /// 0x10feee
u8  bios_cp_p2previous = 0;         /// 0x10feef
u8  bios_cp_p2current = 0;          /// 0x10fef0
u8  bios_cp_p2change = 0;           /// 0x10fef1
u8  bios_cp_p2repeat = 0;           /// 0x10fef2
u8  bios_cp_p2timer = 0;            /// 0x10fef3
u8  _bios_unknown14[4] = {};        /// 4 bytes

// 4 players extension
u8 bios_4p_requested = 0;           /// 0x10fef8
u8 _bios_unknown15 = 0;             /// 1 byte
u8 bios_4p_mode = 0;                /// 0x10fefa
u8 bios_4p_plugged = 0;             /// 0x10fefb

u8  bios_mess_buffer[0x100] = {};   /// 0x10ff00

...
#define PTR_BIOS_SYSTEM_MODE (volatile u8*)0x10fd80
#define BIOS_SYSTEM_MODE  (*PTR_BIOS_SYSTEM_MODE)
extern u8 bios_sysret_status;

// Running hardware
extern u8 bios_mvs_flag;
#define PTR_BIOS_MVS_FLAG (volatile u8*)0x10fd82
#define BIOS_MVS_FLAG     *PTR_BIOS_MVS_FLAG
...
#define PTR_BIOS_USER_REQUEST (volatile u8*)0x10fdae
#define BIOS_USER_REQUEST     *PTR_BIOS_USER_REQUEST
extern u8 bios_user_mode;
#define PTR_BIOS_USER_MODE (volatile u8*)0x10fdaf
#define BIOS_USER_MODE     *PTR_BIOS_USER_MODE
...
#define PTR_BIOS_PLAYER_MOD1 (volatile u8*)0x10fdb6
#define BIOS_PLAYER_MOD1     *PTR_BIOS_PLAYER_MOD1
